...
const logUser = document.getElementById('user')
...
async function userLogued(usuario){
    
    const usuarioLogueado = await fetch('/logueado.hbs')  
    const plantilla = await usuarioLogueado.text()  
